...
class CGAN:
    ...
    def _define_gan(self, generator, discriminator):
        ...
        to the discriminator. optimizer is RMSPROP and the loss is calculated with binary cross entropy.
        :param generator:
        :param critic:
        :return:
        """
    ...
    def train(self, dataset, batch_size, gan_sample_generator, X_test, y_test, n_epochs, df_real_not_normalized, experiment_dir, logger):
